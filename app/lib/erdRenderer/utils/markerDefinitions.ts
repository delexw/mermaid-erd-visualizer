...
export class MarkerDefinitions {
  ...
  public createAllMarkers(
    ...
    this.createMarkerIfNotExists(defs, `${prefix}marker-many-start${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 12 12',
      refX: 2,
      refY: 6,
      markerWidth: 10,
      ...
      content: (marker) => {
        marker.append('path')
          .attr('d', 'M10,2 L2,6 L10,10 z')
          .attr('fill', color);
      }
    });

    // Zero or one marker (circle + line) - EXACT copy from RelationshipComponent
    this.createMarkerIfNotExists(defs, `${prefix}marker-zero-or-one${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 16 12',
      refX: 14,
      refY: 6,
      markerWidth: 12,
    ...
    this.createMarkerIfNotExists(defs, `${prefix}marker-zero-or-one-start${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 16 12',
      refX: 2,
      refY: 6,
      markerWidth: 12,
    ...
    this.createMarkerIfNotExists(defs, `${prefix}marker-zero-or-more${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 18 12',
      refX: 16,
      refY: 6,
      markerWidth: 14,
      ...
      content: (marker) => {
        ...
        marker.append('path')
          .attr('d', 'M9,2 L16,6 L9,10 z')
          .attr('fill', color);
      }
    });

    // Zero or more start marker - EXACT copy from RelationshipComponent
    this.createMarkerIfNotExists(defs, `${prefix}marker-zero-or-more-start${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 18 12',
      refX: 2,
      refY: 6,
      markerWidth: 14,
    ...
    this.createMarkerIfNotExists(defs, `${prefix}marker-one-or-more${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 18 12',
      refX: 16,
      refY: 6,
      markerWidth: 14,
    ...
    this.createMarkerIfNotExists(defs, `${prefix}marker-one-or-more-start${highlighted ? '-highlighted' : ''}`, {
      viewBox: '0 0 18 12',
      refX: 2,
      refY: 6,
      markerWidth: 14,
