...
import { MermaidUploader, ParseErrorDisplay, ParseSuccessDisplay } from "~/components/MermaidUploader";
            ...
            <div className="bg-white border-b border-gray-200 px-4 py-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  {uploadedFileName && (
                    <span className="text-sm text-gray-600 truncate max-w-48">{uploadedFileName}</span>
                  )}
                </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50">
            <div className="text-center max-w-2xl px-4">
              <svg className="mx-auto h-20 w-20 text-gray-400 mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 17a2 2 0 002-2V7a2 2 0 00-2-2M9 17h6a2 2 0 002-2V7a2 2 0 00-2-2H9m12 0H9" />
              </svg>
              <h3 className="text-2xl font-medium text-gray-900 mb-4">Welcome to ERD Explorer</h3>
              <p className="text-lg text-gray-600 mb-8">
                Upload a Mermaid ERD diagram to start exploring your database schema with our interactive viewer.
              </p>
